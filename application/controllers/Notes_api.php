...
class Notes_api extends CI_Controller {
    ...
    function index()
    {
        ...
        $Notes->setTitle("PHP Notes");
        // $Notes->setNotes("lalit");
        // $Notes->setReminder("lalit");
        // $Notes->setTrash("lalit");
        ...
        //echo "\nCreated Notes are ".$Notes->getTitle();
